...
FixStyle(centrifuge,FixCentrifuge)

#else

#ifndef LMP_FIX_CENTRIFUGE_H
#define LMP_FIX_CENTRIFUGE_H

#include "fix.h"

namespace LAMMPS_NS {

class FixCentrifuge : public Fix {
  friend class FixPour;

 public:
  FixCentrifuge(class LAMMPS *, int, char **);
  ~FixCentrifuge();
  int setmask();
  void init();
  void setup(int);
