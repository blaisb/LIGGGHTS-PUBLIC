...
FixStyle(CI_Ref_tournant,FixCI_Ref_tournant)

#else

#ifndef LMP_FIX_CIREFTOURNANT_H
#define LMP_FIX_CIREFTOURNANT_H

#include "fix.h"

namespace LAMMPS_NS {

class FixCI_Ref_tournant : public Fix {
  friend class FixPour;

 public:
  FixCI_Ref_tournant(class LAMMPS *, int, char **);
  ~FixCI_Ref_tournant();
  int setmask();
  void init();
  void setup(int);
